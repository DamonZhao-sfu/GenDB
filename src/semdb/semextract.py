...
preprocessing). The `Default` driver reproduces the generic behavior.

This module is ENDPOINT-BACKED, so it lives outside `vadar/` — the operator library
there is strictly offline. It imports `resolve_image_path` from `vadar`, never the
reverse.
